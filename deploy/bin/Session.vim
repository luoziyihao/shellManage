...
silent only
cd ~/Works/script_code/shellManage/bin
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +41 rollback.sh
badd +1 ./deploy_ctrade.sh
badd +55 deploy_rollback.py
badd +9 ~/Works/script_code/shellManage/cmd_tst.py
badd +0 deploy.sh
args rollback.sh
edit rollback.sh
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 135 - ((24 * winheight(0) + 14) / 28)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
135
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 33 - ((18 * winheight(0) + 13) / 27)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
33
